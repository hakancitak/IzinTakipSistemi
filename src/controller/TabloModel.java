 ...
 * @author Lenovo
 */
public class TabloModel extends AbstractTableModel{
    ...
    private ArrayList veriler = new ArrayList();
     public TabloModel(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"Kayit No","Sicil No", 
        "İzin Başlangic Tarihi", "İzin Bitis Tarihi",
        "İzin Süre","Kalan İzin Miktarı","İzin Türü","Onay"};
    @Override
